        ...
        'vie': {
			...
			instructions: {
				...
				'Head':
					['Đầu {dir}', ' trên {road}'],
				'Continue':
					['Tiếp theo {dir}', ' trên {road}'],
				'SlightRight':
					['Chếch sang phải', ' trên {road}'],
				'Right':
					['Phải', ' trên {road}'],
				'SharpRight':
					['Sang Phải', ' trên {road}'],
				...
				'Left':
					['Trái', ' trên {road}'],
				'SlightLeft':
					['Chếch sang trái', ' trên {road}'],
				'WaypointReached':
					['Cách điểm đến'],
				'Roundabout':
					['Đi theo {exitStr} lối ra vòng tròn', ' trên {road}'],
				'DestinationReached':
					['Điểm đến đã đạt'],
			},
			formatOrder: function(n) {
...
(function() {
	...
	L.Routing.OSRMv1 = L.Class.extend({
		...
		//	serviceUrl: 'https://router.project-osrm.org/route/v1',
           serviceUrl: 'http://router.project-osrm.org/route/',
        //   serviceUrl : sUrl_OSM_Server+'WebService_Map.asmx',
			profile: 'driving',
			timeout: 30 * 1000,
			routingOptions: {
				alternatives: true,
		...
		buildRouteUrl: function(waypoints, options) {
            ...
            //cau hinh cho webservice tren local
             +'/'  + this.options.profile+ '?' +'coordinates=' +
				locs.join(';') + '&' +

//                + '/'+this.options.profile +'/'+ locs.join(';') +'?' +
